...
|:--------|:-----------|:---------------------------------------------------------|:-------------------------------------------------|
| 1.0.0   | 2022-09-15 | [](https://github.com/airbytehq/airbyte/pull/)   | Align with strict-encrypt version                |
...
| Version | Date       | Pull Request                                             | Subject                                                  |
|:--------|:-----------|:---------------------------------------------------------|:---------------------------------------------------------|
| 1.0.0   | 2022-09-15 | [](https://github.com/airbytehq/airbyte/pull/)   | Initial commit. Based on source-postgres-strict-encrypt  |
